...
const char ssid[] = "HARDOMO 2.4G";
//Contraseña de la red Wifi
const char pass[] = "CresposM812";

//Usuario uniandes sin @uniandes.edu.co
#define HOSTNAME "al.cardona"

//Conexión a Mosquitto
const char MQTT_HOST[] = "iotlab.virtual.uniandes.edu.co";
const int MQTT_PORT = 8082;
//Usuario uniandes sin @uniandes.edu.co
const char MQTT_USER[] = "al.cardona";
//Contraseña de MQTT que recibió por correo
const char MQTT_PASS[] = "202216809";
const char MQTT_SUB_TOPIC[] = HOSTNAME "/";
//Tópico al que se enviarán los datos de humedad
const char MQTT_PUB_TOPIC1[] = "humedad/pereira/" HOSTNAME;
//Tópico al que se enviarán los datos de temperatura
const char MQTT_PUB_TOPIC2[] = "temperatura/pereira/" HOSTNAME;
//Tópico al que se enviarán los datos de luminosidad
const char MQTT_PUB_TOPIC3[] = "luminosidad/pereira/" HOSTNAME;
//Variable que guarda el valor de la medición de la luminosidad
int luminanceValue = 0; 
...
void loop()
{
  ...
  luminanceValue = analogRead(LUMINANCE_SENSOR_PIN);
  Serial.println("Valor leído en el puerto analógico: ");
  Serial.println(luminanceValue);
  // float level = 100 - ((luminanceValue - MIN_VALUE) * 100 / (MAX_VALUE - MIN_VALUE));
  // luminanceValue = level;
  float voltage = luminanceValue * (3.3 / 1023.0);
  float luminanceValue = 100.0 - (voltage * 100.0 / 3.3);
  ...
  json = "{\"value\": "+ String(luminanceValue) + "}";
